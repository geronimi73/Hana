...
from utils import latent_to_PIL, PIL_to_latent, generate, encode_prompt, add_random_noise
...
dataset_repo ="g-ronimo/MNIST_64px-latents_dc-ae-f32c32-sana-1.0"
...
for e in range(epochs):
    ...
    wandb.log({"step": step, "epoch": epoch, "loss_eval": el})
