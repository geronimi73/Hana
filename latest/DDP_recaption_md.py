...
def process(rank, is_master, world_size):
	...
	ds_target = "g-ronimo/imagenet-1k-vl-enriched_moondream2"
	in_labels = load_imagenet_labels()
	prompt_template = "This is an image of a {class_name}. The current image caption is {caption}. Please write a short caption based on the image content and the current caption. Keep it short and precise."
	batch_size = 1
	...
	tokenizer = AutoTokenizer.from_pretrained(model_repo, revision="2025-01-09")
