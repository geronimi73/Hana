...
__all__ = ['seed', 'dtype', 'device', 'debug', 'ddp', 'model_config', 'data_config', 'train_config', 'eval_config', 'in1k_recaps',
           ...
           'wandb_run', 'steps_epoch', 'step', 'last_step_time', 'load_models', 'add_random_noise', 'eval_loss',
           'ImageNet96ARDataset']
...
def load_models(text_encoder, transformer_config, ae, dtype, device):
    ...
    te = Siglip2TextModel.from_pretrained(text_encoder, torch_dtype=dtype).to(device)
...
model_config = SimpleNamespace(
    ...
    transformer_config = "transformer_Sana-DiT-B-SIGLIP2.json",
...
if is_master:
    wandb.finish()
    transformer.module.push_to_hub(f"g-ronimo/hana-alpha38")
